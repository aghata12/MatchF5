...
export default {
  ...
  methods: {
    async onChangeFile(event) {
      ...
      this.jsonCoders = XLSX.utils.sheet_to_json(worksheetCoders,{defval:""})
      this.jsonRecruiters = XLSX.utils.sheet_to_json(worksheetRecruiters,{defval:""})
    ...
    orderJSON(jsonToOrder){    
      let orderList=["EMPRESA", "NOMBRE DEL RECRUITER", "EMAIL",	"CARGO","LINKEDIN"]
      let orderedJSON=[]
